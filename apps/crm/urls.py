...
urlpatterns = [
    ...
    path('leads/<int:pk>/mensagens/', lead_messages, name='lead-messages'),
    ...
    path('leads/<int:pk>/proposta/pre-visualizar/', lead_proposal_preview, name='lead-proposal-preview'),
    path('leads/<int:pk>/proposta/enviar/', lead_proposal_send, name='lead-proposal-send'),
